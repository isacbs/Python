...
def desenha_formas(params):
    if params['forma'] == RETANGULO:
        ...
        pygame.draw.rect(params['surface'],params['cor'],(params['x'],params['y'],
...
def desafio2():
    ...
    while True:
        ...
        def_1 = {'cor': cor_atual1, 'surface': surface, 'forma':
RETANGULO,'x':x1, 'y':y1,'width': width,'height':height}
        def_2 = {'cor': cor_atual2, 'surface': surface, 'forma':
RETANGULO,'x':x2, 'y':y2,'width': width,'height':height}
        def_3 = {'cor': cor_atual3, 'surface': surface, 'forma':
RETANGULO,'x':x3, 'y':y3,'width': width,'height':height}
        def_4 = {'cor': cor_atual4, 'surface': surface, 'forma':
RETANGULO,'x':x4, 'y':y4,'width': width,'height':height}
        def_5 = {'cor': cor_atual5, 'surface': surface, 'forma':
RETANGULO,'x':x5, 'y':y5,'width': width,'height':height}
        def_6 = {'cor': cor_atual6, 'surface': surface, 'forma':
RETANGULO,'x':x6, 'y':y6,'width': width,'height':height}
